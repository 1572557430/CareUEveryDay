...
//                "北京市", "北京市", "1999-08-08", "2011-04-16", "oKDeC6tAO_RFbwp4R7tJF3t39H4I");
//        Wx.sendTemplateMessage(MessageFactory.resolveMessage(girlFriend));

        // new 一个 男友 也可单独针对一个friend设置模板ID 以达到不同人不同消息
        BoyFriend boyFriend = new BoyFriend("王帅",
                "北京市", "北京", "2000-08-17", "2011-04-16", "oKDeC6tAO_RFbwp4R7tJF3t39H4I", "xS7F988cvPrVdMi6JRO2pSrTSBPaCWubUW5XRAaxL-w");
